...
Author: Chandra Mouli Mudumba, Rajneesh Kumar, Rahul S Pawar 
...
2D Piano Roll spatial patterns
Bi-LSTM
Bidirectional LSTM
Sequential temporal dependencies
MusicBERT (Variant)
Transformer (BERT-based)
Self-attention with OctupleMIDI tokenization
...
1.
Open Chandra_Mouli_Mudumba_Final_Team_Project.ipynb in Google Colab.

2.
The first cell installs all required dependencies.

3.
Upload your MIDI dataset to the Colab runtime.
...
This project is for academic purposes as part of the MS Applied AI program by University of San Diego 
